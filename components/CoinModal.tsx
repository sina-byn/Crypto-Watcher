...
const CoinModal: FC<Props> = ({ selectMode }) => {
  ...
  if (modalInfo) {
    ...
    return (
      <section
        className={`${
          !selectMode && isModalShown ? "flex" : "hidden"
      ...
      >
        ...
        <div className='flex items-end w-full bg-gradient-to-r from-stop-1 to-stop-2 rounded-t-3xl'>
          <div className='modal-data flex flex-col items-center justify-center gap-y-6 w-full relative bg-gradient-to-t from-primary-dark to-primary-light rounded-t-3xl translate-y-[3px] pb-6'>
